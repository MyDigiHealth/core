...
export type { CertificationManager } from "./contracts/CertificationManager";
export { CertificationManager__factory } from "./factories/contracts/CertificationManager__factory";
export type { PrescriptionManager } from "./contracts/PrescriptionManager";
export { PrescriptionManager__factory } from "./factories/contracts/PrescriptionManager__factory";
